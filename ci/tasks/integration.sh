...
scp -i ssh.key -o "StrictHostKeyChecking no" -r voyager-cli  ${INTEGRATION_VM_USER}@${INTEGRATION_VM_IP}:$project_path

integration_file=$PWD/voyager-cli/ci/tasks/run-integration.sh
