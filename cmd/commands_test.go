...
import (
	...
	"github.com/RackHD/voyager-cli/cmd"
)
...
var _ = Describe("Commands", func() {
	...
	BeforeEach(func() {
		...
		StateFile = fmt.Sprintf("%s/.voyager", dir)
	})
	...
	Describe("Test the  commands", func() {
		...
		Context("call target with valid input", func() {
			It("INTEGRATION should set info for the target voyager", func() {
				ExpectedResponse := cmd.InfoResponse{Name: "voyager"}
				expectedResponseData, _ := json.Marshal(ExpectedResponse)
